...
const INDUSTRIES = [
  ...
  "Food & Beverage", "Cloud Kitchen", "Digital Marketing", "Fitness Studio",
  "EV Charging Station", "Online Education Platform", "Organic Grocery Store",
  "Co-working Space", "Pet Care Services", "Mobile Repair Shop",
  "E-commerce Store", "Health Diagnostics Lab", "Solar Installation",
  "Food Delivery Hub", "AI Services Firm",
];
